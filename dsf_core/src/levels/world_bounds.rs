...
impl WorldBounds {
    ...
    pub fn encloses(&self, pos: &Pos, dimensions: &IVec2) -> bool {
        self.x() <= pos.x
            && self.y() <= pos.y
    ...
    /// If position is outside world bounds, wrap around to other side of the level.
    pub fn wrapped(&self, pos: &Pos) -> Pos {
        Pos::new(
