...
impl TileDefinition {
    ...
    pub fn fallback() -> Self {
        TileDefinition {
            ...
            climbable: false,
            collision: None,
            asset: Some(AssetType(SpriteType::NotFound, 0)),
            preview_asset: None,
            archetype: None,
    ...
    pub fn is_trapped(&self) -> bool {
        self.archetype == Some(Archetype::TrapWall)
    }

    pub fn is_revolving(&self) -> bool {
        matches!(self.archetype, Some(Archetype::RevolvingDoor(_)))
    }
...
impl DepthLayer {
    pub fn z(&self) -> f32 {
        match self {
            ...
            DepthLayer::BackgroundScrim => 10.,
            DepthLayer::DebugLines => 50.,
            DepthLayer::Blocks => 100.,
            DepthLayer::FloatingBlocks => 110.,
            DepthLayer::Enemies => 120.,
            DepthLayer::Player => 130.,
            DepthLayer::Particles => 140.,
            DepthLayer::Selection => 210.,
            DepthLayer::Cursor => 220.,
            DepthLayer::UiElements => 300.,
            // NB: The camera hovers at Z level 1000.
        }
    }
}
